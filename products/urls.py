...
urlpatterns = [
    ...
    path('seeds/winter-flower-seeds/', views.winter_flower_seeds),
    path('seeds/all-seasonal-flower-seeds/', views.all_seasonal_flower_seeds),
    path('seeds/summer-flower-seeds/', views.summer_flower_seeds),
